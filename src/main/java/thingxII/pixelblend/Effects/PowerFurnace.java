...
import thingxII.pixelblend.Config.PowerFurnaceConfig;
import thingxII.pixelblend.ConfigProxy;
import thingxII.pixelblend.mixin.Patch_FurnaceDataAccessor;
...
public class PowerFurnace {
    ...
    public static void OnServerStarted(FMLServerStartedEvent event) {
        ...
        for (PowerFurnaceConfig.EntityConfig config : configs) {
            ...
            PixelmonTrackerCooldownWithData<PowerFurnaceConfig.EntityConfig> newTracker = new PixelmonTrackerCooldownWithData<>(acceptedEntities, (int) (config.getMaxCooldownDuration() * 20), true);
